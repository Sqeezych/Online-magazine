...
const RegisterContainer = ({ className }: RegisterProps) => {
	const {
		register,
		reset,
		handleSubmit,
	...
	const onSubmit = ({ login, password }: RegisterFormData) => {
		requestServer(OPERATIONS.REGISTER, login, password).then(({ error }) => {
			if (error) {
